...
display the student's first name, last name sorted alphabetically, and salary.
in addition, there are displays of the average salary of the employee's function and select and display a random employee
function. The outputs are displayed in the console log. 
